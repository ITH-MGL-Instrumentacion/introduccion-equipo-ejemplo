	...
	\begin{center}
		\begin{tabular}{c c}
			\begin{tabular}{c}
				...
				\textbf{Medina Gil Lamadrid},\\ Nombre1 \\ \texttt{correo1@ejemplo.com} \\ Teléfono: (opcional)
			\end{tabular} &
			\begin{tabular}{c}
				\includegraphics[height=3cm]{perfil2.jpg} \\
				\textbf{Medina Gil Lamadrid,}\\ Nombre2 \\ \texttt{correo2@ejemplo.com} \\ Teléfono: (opcional)
